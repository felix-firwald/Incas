...
{
    internal class UserEditorViewModel : BaseViewModel
    {
        private User _user;
        ...
        {
            get => this._user.id == 1 ? this.ParseFromEnum(PermissionGroup.Admin) : this.ParseFromEnum(this._userParameters.permission_group);
            set
            {
        ...
        public bool StatusEditable => this._user.id != 1 && this._user.username != "admin";
        public bool UsernameEditable => this._user.id == 0;
        ...
        {
            get => this._userParameters.tasks_visibility;
            set
            {
        ...
        {
            get => this._userParameters.communication_visibility;
            set
            {
        ...
        {
            get => this._userParameters.database_visibility;
            set
            {
        ...
        {
            get => this._userParameters.create_templates;
            set
            {
        ...
        {
            get => this._userParameters.modify_templates;
            set
            {
        ...
        {
            get => this._userParameters.write_log;
            set
            {
        ...
        {
            get => this._userParameters.write_listen_log;
            set
            {
