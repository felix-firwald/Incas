...
namespace Incas.Core.Classes
{
    ...
    public static class Permission
    {
        ...
        )
        {
            return mode switch
            {
                PermissionMode.Rising => InRisingAccess(requiredGroup),
                PermissionMode.Monopoly => InMonopolyAccess(requiredGroup),
                PermissionMode.Cascade => InCascadeAccess(requiredGroup),
                _ => throw (new Exception($"Unknown type of permission mode: {mode} got.")),
            };
        }
